...
/** Marquage des bordures de pixels
 * @param img une image (forméé de superpixels d'une même couleur)
 * @return l'image où les changements de pixels ont été marqué en bleu
 **/
